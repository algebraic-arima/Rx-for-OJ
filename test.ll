...
start:
  %i = alloca [4 x i8]
  %stack = alloca [68 x i8]
  call void @new(ptr sret([68 x i8]) %stack)
  store i32 0, ptr %i
  br label %bb2
...
bb3:                                              ; preds = %bb2
  %_7 = call i32 @getInt()
  call void @push(ptr %stack, i32 signext %_7)
  %0 = load i32, ptr %i
  %1 = add i32 %0, 1
  store i32 %1, ptr %i
  br label %bb2
...
bb6:                                              ; preds = %bb2, %bb9
  %_9 = call zeroext i1 @empty(ptr %stack)
  br i1 %_9, label %bb8, label %bb9

bb9:                                              ; preds = %bb6
  %_11 = call i32 @pop(ptr %stack)
...
define void @new(ptr sret([68 x i8]) %_0) {
start:
  %_1 = alloca [64 x i8]
  %ms = call ptr @builtin_memset(ptr %_1, i8 0, i32 64, i1 false)
  %mc = call ptr @builtin_memcpy(ptr %_0, ptr %_1, i32 64, i1 false)
  %0 = getelementptr i8, ptr %_0, i32 64
  store i32 0, ptr %0
  ret void
}

define void @push(ptr %self, i32 signext %value) {
start:
  %0 = getelementptr i8, ptr %self, i32 64
  %_3 = load i32, ptr %0
  %1 = getelementptr i32, ptr %self, i32 %_3
  store i32 %value, ptr %1
...
define zeroext i1 @empty(ptr %self) {
start:
  %0 = getelementptr i8, ptr %self, i32 64
  %_2 = load i32, ptr %0
  %_0 = icmp eq i32 %_2, 0
